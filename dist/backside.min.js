...
"use strict";function pathSplit(t){return t.split("/").filter(function(t){return t.length>0})}function Backside(t,e){if(this._data={},util.isString(t)){var i=url.parse(t);e=i.pathname||"/",this._connection=connectionManager.fromUrl(i.protocol,i.host)}else{if(!util.isObject(t))throw new Error("");this._connection=t}this._pathArray=util.isArray(e)?e:pathSplit(e),this._path="/"+this._pathArray.join("/")}var url=_dereq_("url"),ArraySet=_dereq_("./ArraySet"),util=_dereq_("./util"),connectionManager=_dereq_("./connectionManager"),DataSnapshot=_dereq_("./DataSnapshot"),validEvents=["value"],validEventErr=new Error('First argument must be a valid event type ("'+validEvents.join('", "')+'").');Backside.prototype.child=function(t){return t=pathSplit(t),new Backside(this._connection,this._pathArray.concat(t))},Backside.prototype.parent=function(){return new Backside(this._connection,this._pathArray.slice(0,this._pathArray.length-1))},Backside.prototype.set=function(t){this._connection.send(this._path,t)},Backside.prototype._subscribeIfNecessary=function(){if(!this._listeners){this._listeners={};for(var t=validEvents.length-1;t>=0;t--)this._listeners[validEvents[t]]=new ArraySet;this._connection.subscribe(this._path,this._onUpdate.bind(this))}},Backside.prototype._onUpdate=function(t){var e=JSON.parse(t.body),i=pathSplit(e.key).slice(this._pathArray.length);if(i.length){for(var n=this._data||{},r=0;r<i.length-2;r++){var a=i[r];n[a]=n[a]||{},n=n[a]}n[i[i.length-1]]={value:e.message.value}}else this._data=e.message;console.log("data",this._data);var s=this._pathArray[this._pathArray.length-1]||null;this._fire("value",new DataSnapshot(this._data,s))},Backside.prototype.on=function(t,e){if(-1===validEvents.indexOf(t))throw validEventErr;if("function"!=typeof e)throw new Error("Second argument must be a function.");this._subscribeIfNecessary(),this._listeners[t].add(e)},Backside.prototype.off=function(t,e){if(null!=t){if(-1===validEvents.indexOf(t))throw validEventErr;var i=this._listeners[t];return null==e?void i.empty():void i.remove(e)}for(t in this._listeners)this._listeners[t].empty()},Backside.prototype._fire=function(t,e){this._listeners[t].forEach(function(t){t(e)})},module.exports=Backside;
