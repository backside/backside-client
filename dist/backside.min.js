...
"use strict";module.exports=_dereq_("./lib/Backside");

},{"./lib/Backside":3}],2:[function(_dereq_,module,exports){
"use strict";function ArraySet(){this._items=[]}ArraySet.prototype.add=function(t){return this._items.indexOf(t)>-1?!1:(this._items.push(t),!0)},ArraySet.prototype.remove=function(t){var e=this._items.indexOf(t);return-1===e?!1:(this._items.splice(e,1),!0)},ArraySet.prototype.has=function(t){return this._items.indexOf(t)>-1},ArraySet.prototype.forEach=function(t){return this._items.forEach(t)},ArraySet.prototype.empty=function(){this._items.length=0},module.exports=ArraySet;

},{}],3:[function(_dereq_,module,exports){
"use strict";function pathSplit(t){return t.split("/").filter(function(t){return t.length>0})}function Backside(t,e){if(util.isString(t)){var i=url.parse(t);e=i.pathname||"/",this._connection=connectionManager.fromUrl(i.protocol,i.host)}else{if(!util.isObject(t))throw new Error("");this._connection=t}this._pathArray=util.isArray(e)?e:pathSplit(e),this._path="/"+this._pathArray.join("/"),this._name=this._pathArray[this._pathArray.length-1]||null}var url=_dereq_("url"),ArraySet=_dereq_("./ArraySet"),util=_dereq_("./util"),connectionManager=_dereq_("./connectionManager"),DataStore=_dereq_("./DataStore"),validEvents=["value"],validEventErr=new Error('First argument must be a valid event type ("'+validEvents.join('", "')+'").');Backside.prototype.child=function(t){return t=pathSplit(t),new Backside(this._connection,this._pathArray.concat(t))},Backside.prototype.parent=function(){return new Backside(this._connection,this._pathArray.slice(0,this._pathArray.length-1))},Backside.prototype.set=function(t){this._connection.send(this._path,t)},Backside.prototype._subscribeIfNecessary=function(){if(!this._listeners){this._data=new DataStore(this._name),this._listeners={};for(var t=validEvents.length-1;t>=0;t--)this._listeners[validEvents[t]]=new ArraySet;this._connection.subscribe(this._path,this._onUpdate.bind(this))}},Backside.prototype._onUpdate=function(t){var e=JSON.parse(t.body),i=pathSplit(e.key).slice(this._pathArray.length);null==e.message?this._data.remove(i):this._data.set(i,e.message),this._fire("value",this._data.snapshot())},Backside.prototype.on=function(t,e){if(-1===validEvents.indexOf(t))throw validEventErr;if("function"!=typeof e)throw new Error("Second argument must be a function.");this._subscribeIfNecessary(),this._listeners[t].add(e)},Backside.prototype.off=function(t,e){if(null!=t){if(-1===validEvents.indexOf(t))throw validEventErr;var i=this._listeners[t];return null==e?void i.empty():void i.remove(e)}for(t in this._listeners)this._listeners[t].empty()},Backside.prototype._fire=function(t,e){this._listeners[t].forEach(function(t){t(e)})},module.exports=Backside;

},{"./ArraySet":2,"./DataStore":6,"./connectionManager":7,"./util":8,"url":15}],4:[function(_dereq_,module,exports){
"use strict";function Connection(n){var t=Q.defer();this._connection=t.promise;var e=new WebSocket(n+"/socks/websocket");this.client=window.client=Stomp.over(e),this.client.debug=function(){},this.client.connect({},function(){t.resolve()})}var Q=_dereq_("q"),Stomp=_dereq_("stompjs/lib/stomp").Stomp;Connection.prototype.subscribe=function(n,t){var e=this;this._connection.then(function(){e.client.subscribe(n,t)})},Connection.prototype.send=function(n,t){var e=this;this._connection.then(function(){e.client.send(n,{},JSON.stringify(t))})},module.exports=Connection;

},{"q":16,"stompjs/lib/stomp":17}],5:[function(_dereq_,module,exports){
"use strict";function DataSnapshot(t,a){this._data=t,this._name=a}var collapseTree=_dereq_("backside-utils/lib/collapseTree");DataSnapshot.prototype.val=function(){return collapseTree(this._data)},DataSnapshot.prototype.child=function(){},DataSnapshot.prototype.forEach=function(){},DataSnapshot.prototype.hasChild=function(){},DataSnapshot.prototype.hasChildren=function(){},DataSnapshot.prototype.name=function(){return this._name||null},DataSnapshot.prototype.numChildren=function(){},DataSnapshot.prototype.ref=function(){},DataSnapshot.prototype.getPriority=function(){},DataSnapshot.prototype.exportVal=function(){},module.exports=DataSnapshot;

},{"backside-utils/lib/collapseTree":9}],6:[function(_dereq_,module,exports){
"use strict";function DataStore(t){this._data=null,this._name=t}var DataSnapshot=_dereq_("./DataSnapshot");DataStore.prototype.set=function(t,a){if(!t.length)return this._setRoot(a);for(var e=this._data||{},o=0;o<t.length-2;o++){var r=t[o];e[r]=e[r]||{},e=e[r]}null==a?delete e[t[t.length-1]]:e[t[t.length-1]]={value:a.value},this._data=e},DataStore.prototype.remove=function(t){this.set(t,null)},DataStore.prototype.snapshot=function(){return new DataSnapshot(this._data,this._name)},DataStore.prototype._setRoot=function(t){var a=this._data;this._data=t;var e={};for(var o in a)e[o]=!0;var r=[];for(o in t)e[o]?delete e[o]:r.push(o);return{removed:Object.keys(e),added:r}},module.exports=DataStore;

},{"./DataSnapshot":5}],7:[function(_dereq_,module,exports){
"use strict";var Connection=_dereq_("./Connection"),connections={};module.exports={fromUrl:function(n,o){"https:"===n?n="wss:":"http:"===n&&(n="ws:");var t=n+"//"+o;return connections[t]?connections[t]:(connections[t]=new Connection(n+"//"+o),connections[t])}};

},{"./Connection":4}],8:[function(_dereq_,module,exports){
"use strict";var ots=Object.prototype.toString;module.exports={isString:function(t){return"string"==typeof t},isArray:function(t){return"[object Array]"===ots.call(t)},isObject:function(t){return"[object Object]"===ots.call(t)}};

},{}],9:[function(_dereq_,module,exports){
function _collapseTree(e,l){for(var u in e){var r=e[u];null===r||("object"!=typeof r.value?l[u]=r.value:(l[u]={},_collapseTree(e[u].value,l[u])))}}module.exports=function(e){if("object"!=typeof e)return e;if(null==e)return null;if(e.value&&"object"!=typeof e.value)return e.value;var l={};return _collapseTree(e,l),0===Object.keys(l).length?null:l};
